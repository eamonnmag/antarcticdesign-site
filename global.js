...
$(document).ready(function(){ 
	CalculateWindow();
	$("#dragBtn").draggable({ axis: "x", containment: "parent", drag: function(e){ MoveContainer(e) }, stop: function(){$("#layer3").css("background","url('img/penguin.png') right no-repeat");} });
...
function MoveContainerClick(toWhat) {
	...
	if(currPos != P) {
		...
		$("#dragBtn").animate({left: P},anSpeed,function(){$("#layer3").css("background","url('img/penguin.png') right no-repeat");});
